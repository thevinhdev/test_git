...
<head>
    ...
    <!-- CKEditor & ckfinder-->
    <!-- <script type="text/javascript" src="public/backend/js/ckeditor1/ckeditor.js"></script>
    <script type="text/javascript" src="{{ url('public/backend/js/ckfinder1/ckfinder.js') }}"></script> -->
 
    <!-- <script type="text/javascript" src="{{ url('backend/js/ckeditor/ckeditor.js') }}"></script>
    <script type="text/javascript" src="{{ url('backend/js/ckfinder/ckfinder.js') }}"></script> -->
 ...
 -->
    ...
    <!--  <script type="text/javascript" src="{{ url('backend/js/func_ckfinder.js') }}"></script> -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Admin - The Vinh</a>
            </div>
            <!-- /.navbar-header -->
