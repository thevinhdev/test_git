...
<div>
          ...
          <ul class="thumbnails mainimage">
            <li class="span5">
              <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="img/product1big.jpg">
                <img src="{!! asset('uploads/'.$detailProduct->image) !!}" alt="" title="">
              </a>
            </li>
            <li class="span5">
  ...
  <div class="fb-comments" data-href="http://localhost:8000/chi-tiet-san-pham/8/ao-khoac-day" data-width="100%" data-numposts="5"></div>
  <!--  Related Products-->
  <section id="related" class="row">
    <div class="container">
      ...
      <ul class="thumbnails">
      @foreach ($productLatest as $value)
        <li class="span3">
          <a class="prdocutname" href="product.html">{{ $value->name }}</a>
          <div class="thumbnail">
            <span class="sale tooltip-test">Sale</span>
            <a href="#"><img alt="" src="{!! asset('uploads/'.$value->image) !!}"></a>
            <div class="pricetag">
